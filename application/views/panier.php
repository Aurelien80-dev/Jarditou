...
$title='Panier - Jarditou'; ?>
            	...
            	<td>
            		<div class="panier_qte">
                    	<button class="panier_qte_bouton" type="button" role="button">
                    		<a href="<?= site_url('boutique/qtemoins/'.$produit['pro_id']) ?>" name='pro_id'><i class="fas fa-minus"></i></a>
                    	</button>
                    		<div class="panier_qte_valeur" name ='pro_qte'><?= $produit['pro_qte'] ?></div> <!-- affichage de la quantité de chaque produit, blocage à 1 si l'utilisateur essaye d'aller en-dessous de 1 -->
                    	<button class="panier_qte_bouton" type="button" role="button">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="deep-orange-text font-weight-bold" name='prix_total'>TOTAL : <?= str_replace('.',',',$total) ?> <sup>€</sup></h5>
    ...
    <div class="alert alert-danger">Votre panier est vide. Pour le remplir, vous pouvez visiter notre <a href="<?= site_url("produits/listes/") ?>">boutique</a>.</div>
