<?php $title='Modif d\'un produit'; ?>
    
    <?php ob_start(); ?>
    
<body>
<h1>Produits a modifier</h1><hr>


<?php echo form_open(); ?><fieldset class="text-warning bg bg-dark">
...
<label for="pro_prix">Prix du produit: </label><input type="number" step="0.01" name="pro_prix" value="<?php echo $produits->pro_prix?>"class="form-control"/><br>
